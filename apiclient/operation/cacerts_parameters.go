...
// WithDefaults hydrates default values in the cacerts params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacertsParams) WithDefaults() *CacertsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cacerts params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacertsParams) SetDefaults() {
