...
/* SimplereenrollParams contains all the parameters to send to the API endpoint
   for the simplereenroll operation.
...
// WithDefaults hydrates default values in the simplereenroll params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SimplereenrollParams) WithDefaults() *SimplereenrollParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the simplereenroll params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SimplereenrollParams) SetDefaults() {
